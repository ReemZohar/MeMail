...
std::vector<bool> getBLFromBLFile(const std::filesystem::path& filePath);
...
std::vector<bool> loadBLFromFile(const std::string& length, const std::filesystem::path& filePath);
